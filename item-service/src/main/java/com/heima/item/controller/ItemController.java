...
import com.heima.item.fallback.ItemControllerFallback;
...
public class ItemController {
    ...
    @GetMapping
    @SentinelResource(value = "queryItemByIds",
            fallback = "queryItemByIdsFallback",
            fallbackClass = ItemControllerFallback.class)
